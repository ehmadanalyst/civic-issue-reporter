"""
Civic Issue Reporter & Analyzer - Backend API
Uses Claude API for multimodal analysis of civic infrastructure problems
"""
...
def analyze_issue():
    """
    Analyze a civic issue using Claude's multimodal capabilities
